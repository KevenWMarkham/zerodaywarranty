...
def test_html_is_self_contained_three_js() -> None:
    ...
    # import-map addresses must be valid relative refs (./), not bare specifiers,
    # or the browser resolves them to null ("blocked by a null value").
    assert '"./vendor/three@' in html
    assert '"three/addons/": "./vendor/three@' in html
